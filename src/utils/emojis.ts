...
export const emojisDefault: IEmoji[] = [
  ...
  new Emoji("👱🏼‍♀️", "Peoples", ["blonde_woman"]),
  ...
  new Emoji("👳‍♀️", "Peoples", ["woman_with_turban"]),
  new Emoji("👳", "Peoples", ["man_with_turban"]),
  new Emoji("👮‍♀️️", "Peoples", ["policewoman"]),
  new Emoji("👮", "Peoples", ["policeman", "cop"]),
  new Emoji("👷‍♀️", "Peoples", ["construction_worker_woman"]),
  new Emoji("👷", "Peoples", ["construction_worker_man", "construction_worker"]),
  new Emoji("💂‍♀️", "Peoples", ["guardswoman"]),
  ...
  new Emoji("👯‍♂️", "Peoples", ["dancing_men"]),
  new Emoji("🚶‍♀️", "Peoples", ["walking_woman"]),
  new Emoji("🚶", "Peoples", ["walking_man", "walking"]),
  new Emoji("🏃‍♀️", "Peoples", ["running_woman"]),
  ...
  new Emoji("🤼‍♀️", "Activity", ["women_wrestling"]),
  new Emoji("🤼‍♂️", "Activity", ["men_wrestling"]),
  new Emoji("🤸‍♀️", "Activity", ["woman_cartwheeling"]),
  new Emoji("🤸‍♂️", "Activity", ["man_cartwheeling"]),
  new Emoji("⛹️‍♀️", "Activity", ["basketball_woman"]),
  new Emoji("⛹", "Activity", ["basketball_man"]),
  new Emoji("🤾‍♀️", "Activity", ["woman_playing_handball"]),
  new Emoji("🤾‍♂️", "Activity", ["man_playing_handball"]),
  new Emoji("🏌️‍♀️", "Activity", ["golfing_woman"]),
  new Emoji("🏌", "Activity", ["golfing_man"]),
  new Emoji("🏄‍♀️", "Activity", ["surfing_woman"]),
  new Emoji("🏄", "Activity", ["surfing_man", "surfer"]),
  new Emoji("🏊‍♀️", "Activity", ["swimming_woman"]),
  new Emoji("🏊", "Activity", ["swimming_man", "swimmer"]),
  new Emoji("🤽‍♀️", "Activity", ["woman_playing_water_polo"]),
  new Emoji("🤽‍♂️", "Activity", ["man_playing_water_polo"]),
  new Emoji("🚣‍♀️", "Activity", ["rowing_woman"]),
  new Emoji("🚣", "Activity", ["rowing_man", "rowboat"]),
  new Emoji("🏇", "Activity", ["horse_racing"]),
  new Emoji("🚴‍♀️", "Activity", ["biking_woman"]),
  new Emoji("🚴", "Activity", ["biking_man", "bicyclist"]),
  new Emoji("🚵‍♀️", "Activity", ["mountain_biking_woman"]),
  ...
  new Emoji("🤹‍♀️", "Activity", ["woman_juggling"]),
  new Emoji("🤹‍♂️", "Activity", ["man_juggling"]),
